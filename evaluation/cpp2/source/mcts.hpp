/**
 * This file is from the header-only C++ MCTS library.
 *
 * "C++ MTCS is a header-only framework for the Monte Carlo Tree Search
 * algorithm. By implementing a few classes, the MCTS framework makes it
 * possible to use MCTS in a custom game."
 *
 * See: https://github.com/Konijnendijk/cpp-mcts
 */
